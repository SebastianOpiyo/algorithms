...
/*
* ASSIGNMENT 4 : Delete element from a linear list.
*/
...
void DeleteData(int position){
    ...
    // Otherwise we traverse the list to the posotion needed.
    // We could utilize the linear search function here
    // Instead of rewriting the logic; just need to clean it up.
    int i;
